...
const STATS = [
  { value: '450mi',    label: 'Max Range' },
  { value: '1.8s',    label: 'Fastest 0-60' },
  { value: '1,340hp', label: 'Peak Power' },
...
const WHY_ITEMS = [
  {
    ...
    body: 'Up to 459 miles on a single charge — the longest in class.',
    color: '#0066ff',
  ...
  {
    Icon: Route,
    title: '12,400+ Chargers',
    body: 'The Apex Supercharger network covers all 48 contiguous states.',
    color: '#9b59b6',
