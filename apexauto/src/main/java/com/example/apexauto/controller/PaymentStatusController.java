...
public class PaymentStatusController {
    ...
    // GET /payment-statuses — returns all payment statuses.
    @GetMapping
    ...
    // GET /payment-statuses/{paymentStatusId} — returns one payment status.
    ...
    // POST /payment-statuses — creates a reusable payment status, such as PAID or FAILED.
    @PostMapping
